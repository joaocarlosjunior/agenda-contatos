...
<body>
	<main>
		...
		<form name="formContato" action="update" method="post">
			<input type="hidden" id="contatoId" name="id" value="<%=contato.getId()%>">
			...
			<table>
				...
				<tr class="campoEmail">
					<td><input value="<%=contato.getEmail()%>" class="caixa1"
						...
						placeholder="Email" onblur="validarEmail()"></td>
